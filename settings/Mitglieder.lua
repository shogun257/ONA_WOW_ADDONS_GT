local Type, Version = "Mitglieder", 1
...
local function MoneyString(value)
	if value then
		return GildenSteuer:FormatMoney(floor(value / 100 / 100) * 100 * 100)
	end
	return "-"
end
...
local function Constructor()
	...
	local frame = CreateFrame("Frame", ("Mitglieder%d"):format(num), UIParent)
